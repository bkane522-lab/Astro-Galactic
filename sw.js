const CACHE_NAME="astro-galactic-v16-tableau-integre";
const ASSETS=["/","/index.html","/manifest.json","/assets/message-des-etoiles.png","/icon-192.png","/icon-512.png","/apple-touch-icon.png"];
